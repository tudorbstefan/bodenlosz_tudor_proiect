...
namespace ComicBookStoreProject.Controllers
{
    public class PublishersController : Controller
    {
        ...
        public PublishersController(ComicBookStoreProjectContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Country,Founded")] Publisher publisher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Name,Country,Founded")] Publisher publisher)
        {
            if (id != publisher.ID)
            {
                return NotFound();
